...
export async function getQuranPage(pageNumber) {
	if (
		...
		throw new Error(
			"Qur'an page must be between 1 and 604."
		);
	}
	...
	if (result.code !== 200) {
		throw new Error(
			"Could not return the Qur'an page."
		);
	}
...
export async function getQuranSurah(surahNumber) {
	if (
		...
		throw new Error(
			"Qur'an Surah must be between 1 and 114."
		);
	}
	...
	if (result.code !== 200) {
		throw new Error(
			"Could not return the Qur'an Surah."
		);
	}
...
export async function getQuranSurahs() {
	...
	try {
		...
		if (result.code !== 200) {
			throw new Error(
				"Could not return Qur'an Surahs."
			);
		}
...
export async function getQuranJuz(juzNumber) {
	if (
		...
		throw new Error(
			"Qur'an Juz must be between 1 and 30."
		);
	}
	...
	if (result.code !== 200) {
		throw new Error(
			"Could not return the Qur'an Juz."
		);
	}
