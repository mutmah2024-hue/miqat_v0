...
import { getQiblaDirection } from "../../lib/aladhan";
...
export default function Qibla() {
	 ...
	 */
	const loadQiblaDirection = useCallback(
		async (lat, lon) => {
			try {
				const direction =
	...
	const useManualLocation = async () => {
		...
		const success =
			await loadQiblaDirection(lat, lon);
	...
	useEffect(() => {
		...
		if (savedLatitude && savedLongitude) {
			...
			const lon = Number(savedLongitude);
	 ...
	 * INTO A COMPASS HEADING.
	 */
	const getRawHeading = useCallback(
		(event) => {
			let rawHeading = null;
		...
		<main className="min-h-screen bg-background text-primary">
			<div className="flex min-h-screen">
				...
				<div className="min-w-0 flex-1">
					<div className="mx-auto max-w-5xl px-6 py-10 pb-24 lg:px-10 lg:py-14 lg:pb-14">
						{/* HEADER */}
